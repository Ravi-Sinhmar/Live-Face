    ...
    const autoClickHandler = async () => {
      try {
        ...
        if (
          ...
          needTrack &&
          doneTrack &&
          (userConnection !== "connected" || adminConnection !== "connected")
        ) {
                ...
                <div className="flex justify-between w-full rounded-md ring-2 ring-black items-center px-4 py-2 bg-blm h-fit ">
                  ...
                  >
                    <svg
                      className={
                        !isMicEnabled
                          ? "size-8 p-1 bg-blf text-blm rounded-full"
                          : "size-8 p-1 text-blt rounded-full"
                      }
                      viewBox="0 0 24 24"
                      fill="none"
                  ...
                  <button
                    className="z-10 w-fit bg-blf text-blm px-6 text-sm font-[400] flex text-center items-center justify-center py-2 rounded-full  ring-1 ring-blt shadow-md shadow-blt h-fit"
                    onClick={
                      userConnection !== "connected" && !admin
                        ? handleCallUser
                        : cutCall
                    }
                  >
